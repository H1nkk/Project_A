...
let capitals = ["Вена", "Тирана", "Минск", "София", "Сараево", "Ватикан", "Лондон", "Будапешт", "Берлин", "Копенгаген", "Дублин", "Рейкьявик", "Мадрид", "Рим", "Никосия", "Рига", "Вильнюс", "Люксембург", "Скопье", "Кишинёв", "Амстердам", "Осло", "Варшава", "Лиссабон", "Бухарест", "Белград", "Братислава", "Любляна", "Киев", "Париж", "Загреб", "Подгорица и Цетине", "Прага", "Берн", "Стокгольм", "Таллин"]
...
let capitals_1 =  ["Вена", "Тирана", "Минск", "София", "Сараево", "Ватикан", "Лондон", "Будапешт", "Берлин", "Копенгаген", "Дублин", "Рейкьявик", "Мадрид", "Рим", "Никосия", "Рига", "Вильнюс", "Люксембург", "Скопье", "Кишинёв", "Амстердам", "Осло", "Варшава", "Лиссабон", "Бухарест", "Белград", "Братислава", "Любляна", "Киев", "Париж", "Загреб", "Подгорица и Цетине", "Прага", "Берн", "Стокгольм", "Таллин"] // будут уменьшаться
let i = 35
let right_capital1
let right_country1
...
function checkAnswer1(right_capital, right_country) {
    if (firstbutton.innerText == right_capital) {
        alert("Правильно. " + right_capital + " - столица страны " + right_country)
